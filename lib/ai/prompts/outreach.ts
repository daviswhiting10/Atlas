...
const PURPOSE_GUIDANCE: Record<string, string> = {
  cold_outreach: "First touchpoint. Be specific about why you're reaching out. Mention something you observed or know about them. Do not pitch hard on first contact.",
  check_in: "Genuine check-in on their progress/how they're feeling. Brief. No hard sell.",
  win_back: "Client has churned. Acknowledge the gap without guilt-tripping. Give them a reason to come back. One clear CTA.",
  retention_nudge: "Client is at risk of churning. Warm, direct. Acknowledge any gap in sessions. Make it easy for them to re-engage.",
  post_consult: "Follow up after a consultation/trial session. Reference something specific from the session. Clear next step.",
  referral_ask: "Ask for a referral from a happy active client. Make it easy and specific.",
};

export function buildOutreachPrompt(input: OutreachInput) {
  const methodology = loadMethodology("outreach");
